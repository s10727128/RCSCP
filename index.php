    ...
    <div class="container">
      <div class="row d-flex align-items-center">
        <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
          ...
          <p class="bottom35">現今是一個資訊量爆炸的時代，人們可以很方便的利用網際網路，找尋任何資訊。但也因為網路所帶來的便利，導致許多外表看似華麗的網站，實質上卻是惡意人士所用來犯罪的工具。因此，本網站希望透過遊戲，達到教學與實作的目的，引導玩家操作及理解。同時也透過網站的一些標語，提升玩家的資訊安全意識。
            <br>本網站只提供學習知識，切勿任意在他人網頁上操作，若有法律責任，後果請自行負責。
          </p>
          </div>
