...
<head>
  ...
  <link rel="stylesheet" href="/playgame/SQL Injection game/SQL_summary/SQL0.css">
</head>
...
<div class="modal-header">  
    ...
    <!--  The Modal -->
      ...
      <article v-cloak>
        ...
        <section>
          ...
          <p><img class="photo" src="/photo/SQL/SQL.jpg"></p>
        </section> <section>
          <h2>關卡內容</h2>
  ...
  <script src="/playgame/SQL Injection game/SQL_summary/SQL0.js"></script>
