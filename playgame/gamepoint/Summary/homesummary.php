...
<head>
  ...
  <link rel="stylesheet" href="/RCSCP/playgame/gamepoint/Summary/homesummary.css">
...
<body>
    ...
    <boardal v-if="modal.isOpen" :has-mask="modal.hasMask" :can-click-mask="modal.canClickMask" :has-x="modal.hasX" @toggle="toggleModal">
      ...
      <article v-cloak>
        ...
        <section>
          ...
          <p>原始碼，原文為Source
            Code，是指人類可以讀的電腦語言指令。所以，網頁原始碼，顧名思義就是大家可以看得懂的網頁電腦語言。最常聽到的有HTML、CSS、JavaScript以及PHP，其中HTML、CSS、JavaScript為網頁前端，PHP為網頁後端。<br>(下圖為基本網頁架構的原始碼)<br><img src="/RCSCP/photo/Home summary/Html source code 1.png">那什麼是前端?什麼是後端呢?</p><br>
          <h3>網頁前/後端</h3>
          <p>
        ...
        <section>
          ...
          <img src="/RCSCP/photo/Home summary/HTML Summary Example1.png"><br>
          <img style="width:75%;" src="/RCSCP/photo/Home summary/HTML Summary Example2.png">
        </section>

        <section>
          <h2>JavaScript</h2>
          <p>JavaScript的主要目的在於，寫出"功能"，就像手遊裡打怪的攻擊鈕，按下去會打怪，也是要有功能。(下圖為設計按鈕作動的程式碼)</p>
          <img src="/RCSCP/photo/Home summary/HTML Summary Example3.png"><br><br>
          <p>每攻擊5下，會有一次爆擊</p>
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example4.png"><br>
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example5.png">
        </section>

        <section>
          <h2>CSS</h2>
          <p>剛剛我們有提到過，CSS會與HTML及JavaScript相互搭配使用，CSS主要的功能就是美化網頁，將網頁內容的古板單調風格轉換成栩栩如生。(下圖為設計按紐樣式的程式碼)</p><br>
          <h1><a href="/RCSCP/playgame/gamepoint/Summary/homesummary/homesummary.html"><b>我想按按看!</b></a></h1>
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example6.png"><br>
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example7.png"><br>
        </section>
        ...
        <section>
          ...
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example8.png"><br>
          <img style="width: 50%;" src="/RCSCP/photo/Home summary/HTML Summary Example9.png"><br>
        </section>
  ...
  <script src="/RCSCP/playgame/gamepoint/Summary/homesummary.js"></script>
